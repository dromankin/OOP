...
class MainTest {
    ...
    void test_2_negative_result() {
        ...
        assertFalse(Arrays.equals(new int[] {1, 3, 2, 4, 5}, Main.heapsort(arr)));
    }
    ...
    void test_8_different_arrays() {
        ...
        assertFalse(Arrays.equals(new int[] {1, 2, 3, 4, 5, 9, 45}, Main.heapsort(arr)));
    }

    @Test
    void test_9_only_same_numbers() {
        int[] arr = new int[] {0, 0, 0, 0, 0};
        assertTrue(Arrays.equals(new int[] {0, 0, 0, 0, 0}, Main.heapsort(arr)));
    }
